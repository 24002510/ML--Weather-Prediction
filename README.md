...
4.Fill missing values using interpolation

5.Extract hour from time column

6.Convert hour into sine and cosine features

7.Create lag features for temperature, PM2.5, and TSR

8.Remove rows with missing values after lag creation

9.Define input features and target variables

10.Split dataset into training (80%) and testing (20%) sets

11.Train Random Forest Regressor model for each target

12.Predict values using test data

13.Evaluate performance using R² and MAE

14.Visualize actual vs predicted values

15.Display feature importance

16.Use latest data for real-time prediction
...
<img width="943" height="423" alt="image" src="https://github.com/user-attachments/assets/cd7ea29d-c53a-457c-80f1-f7691bf05ea2" />
